...
career_list = [ #学校
                ...
                #工作
                '社畜', '模特', '电竞选手', '干净又卫生主播', '美妆博主', '魔术师', '潜水员', '实习生', 
                '花店店员', '厨师', '歌手', '演员', '片警', '程序员', '作家', '画师', '摄影师', '牙医', 
                '医生', '兽医', '鱼贩',  '设计师', '乌龟饲养员', '护林员', '飞行员', '公交车司机', 
                '便利店收银员', '婚礼主持人', '商人', '老板', '大副', '记者', '美食家', '保镖', 
                '石油大亨', '基金经理', 'HR', '清洁工', '脱口秀演员', '色情主播', '无业游民', 
                '探险家', '王位继承人', '总裁', '秘书',
                #标签
                '福瑞控', '阿宅', '显卡发烧友', '暴走族', '海底捞拉面大师', '富二代', '棕熊', '工具人',
                #西幻
                '天使', '恶魔', '堕天使', '魅魔', '人鱼', '吸血鬼', '丧尸', '人马', '傲罗', '神父', 
                '祭司', '吟游诗人', '巫师', '海盗', '魔法师', '骑士', '精灵', '神奇动物', '超级英雄', 
                '摸金校尉', '牧马人', '龙', '矮人', '召唤师', '武士', '剑士', '亡灵', '刺客',
                #科幻
                '高达驾驶员', '仿生人', '机器人', '外星人', 
                #传统神话
                '月老', '天师', '狐狸精', '道士', '书生', '笔仙'
...
adj_list = ['温柔的', '显著帅过正常人的', '暴躁的', '凶残的', '勇敢的', '喜欢看电影的',
            ...
            '有神秘超能力的', '终于决定摆烂的', '一天不抬杠浑身难受的',
            '动态视力绝佳的', '手速全服第一的','看过很多电影的']
...
event_list = ['写论文时', '吃饭时', '看黄片时', '屠龙时', '猎魔时',
              ...
              '喝酒时', '写辞职信时', '喝茶水嗑瓜子看电视时', '试图种菜时', '给猫洗澡时', '创作色情小说时', 
              '试图用鼻子碰到自己的胳膊肘时', '洗裤衩时',
